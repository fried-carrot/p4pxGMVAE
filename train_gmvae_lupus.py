#!/usr/bin/env python
# COPY-PASTE from bulk2sc_GMVAE/_3_model_train_GMVAE/main_zinb.py with annotations
...
# MODIFIED: Using files in current directory
sys.path.insert(1, '.')
...
# MODIFIED: default path from "./data/lung_10k/" to "data_processed/lupus_gmvae/"
...
#### train data loaded ####
# MODIFIED: default batch-size from 37 to 128
parser.add_argument('--batch-size', type=int, default=128, metavar='N',
					help='input batch size for training (default: 128)')
# MODIFIED: default epochs from 13 to 200
...
# MODIFIED: added default='lupus' (was no default)
...
# MODIFIED: pickle filename from "args_save_zinb.pickle" to f"{args.modelsaveloc}/args_{args.dataset}.pickle"
...
if not (args.restart):
    ...
    # ADDITION: Save final model state dict for loading in P4P
